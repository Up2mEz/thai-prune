"""Kaggle bootstrap for one immutable Stage 0 Repair v2 submission."""
...
def main() -> None:
    ...
    try:
        ...
        phase = "stage0_repair_v2"
        spec_path = Path("/tmp/labbs2026-stage0-repair-v2-spec.json")
        _atomic_json(spec_path, spec)
        _run(
            [
                str(source / ".venv/bin/python"),
                "-m",
                "labbs2026.stage0.repair_v2",
                "--remote-spec",
                str(spec_path),
            ],
            source,
