...
def inspect_source_of_truth(root: Path) -> ConsistencyResult:
    ...
    _require(
        ...
        and (
            ...
            in active_plan
            or "Steps 4–6 — Stage 0 | `QWEN35_MEASUREMENT_DIAGNOSTIC_AUTHORIZED`"
            in active_plan
            ...
            or "Steps 4–6 — Stage 0 | `PILOT_INFERENCE_AUTHORIZED`"
            or "Steps 4–6 — Stage 0 | `PILOT_COMPLETE_HUMAN_REVIEW_REQUIRED`"
            in active_plan
        ),
