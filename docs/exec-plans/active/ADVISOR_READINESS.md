...
**Status:** STAGE 0 QWEN3.5 MEASUREMENT DIAGNOSTIC AUTHORIZED
...
| Steps 4–6 — Stage 0 | `QWEN35_MEASUREMENT_DIAGNOSTIC_AUTHORIZED` | Qwen3.5 open calibration was chance-level with dominant A-position bias; D1–D4 are pre-registered on open calibration only and must stop for human review; Gate 0 remains `NOT_RUN` and locked validation is blocked |
